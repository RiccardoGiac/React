...
const RegistrationScreen = ({ navigation }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.email.trim()) {
      ...
      newErrors.cemail = 'Errore nel campo Email';
      isValid = false;
    }
    ...
    if (!formData.cemail.trim()) {
      newErrors.cemail = "La conferma email è obbligatoria";
      isValid = false;
    } else if (formData.cemail != formData.email) {
      newErrors.cemail = 'Inserisci la stessa email';
      isValid = false;
    }
    ...
    <ScrollView style={styles.container}>
      <View style={styles.formContainer}>
        ...
        <View style={styles.inputGroup}>
          ...
          <TextInput
            style={[styles.input, errors.cemail && styles.inputError]}
            value={formData.cemail}
            onChangeText={(text) => setFormData({ ...formData, cemail: text })}
            placeholder="Conferma la tua email"
            keyboardType="email-address"
            autoCapitalize="none"
          />
          {errors.cemail && <Text style={styles.errorText}>{errors.cemail}</Text>}
        </View>
